...
namespace UPProjects.Controllers
{
    public class HomeController : Controller
    {
        ...
        public HomeController(DAL _dal, AppCommonMethod _acm, IWebHostEnvironment _env)
        {
            dAL = _dal;
            acm = _acm;
            env = _env;
        ...
        public IActionResult NamamiGange()
        {
            List<NamamiGange> result = new List<NamamiGange>();
            try
            {

                //var param = new { AlbumId = id };
                result = DB_Conn.SelectProcedureExecute<NamamiGange>("GetNamamiGangePhoto", null);
        ...
        public IActionResult Jhansi()
        {
            return View();
        }
        public IActionResult Mahoba()
        {
            return View();
        }
        ...
        public IActionResult Prayagraj()
        {
            return View();
        }
        public IActionResult jhansiongoing()
        {
            return View();
        }
        public IActionResult mahoba()
        ...
        public IActionResult pondongoing()
        {
            return View();
        }
        public IActionResult varanasi()
        ...
        public IActionResult kaushambi()
        {
            return View();
        }
        public IActionResult rampur()
        {
            return View();
        }

        public IActionResult bareilly()
        {
            return View();
        }
        public IActionResult bhubaneswar()
        {
            return View();
        }

        public IActionResult civilhospital()
        {
            return View();
        }
        public IActionResult ghaziabad()
        {
            return View();
        }
        public IActionResult hardoi()
        {
            return View();
        }
        public IActionResult jyotibaphulenagar()
        {
            return View();

        }
        public IActionResult kanpur()
        {
            return View();
        }
        public IActionResult lucknow()
        {
            return View();
        }
        public IActionResult meerut()
        {
            return View();
        }
        ...
        public IActionResult frmContractorNew()
        {
        ...
        public IActionResult ContractorRenewal()
        {
            ViewBag.Mobile = TempData["Mobile"].ToString();
            return View();
        }
        [HttpGet]
        public async Task<JsonResult> CheckContractorRenewalMobile(string Mobile)
        {
            ...
            try
            {
                ...
                var result = await dAL.QueryAsync("CheckContractorRenewalMobile", param);
                res = new
                {
                    InnerResult = result,
                    Status = 1
        ...
        public JsonResult ContractorRenewalSubmit(ContractorRenewal contractor)
        {
            ...
            try
            {
                ...
                {
                    string RequestFile = "", OldRegistration = "", CharacterCertificate = "", HasiyatCertificate = "", WorkCertificate = "", StampCertificate = "", DemandDraft = "", GSTR1 = "", GSTR2 = "";
                    if (contractor.RequestFile != null)
                        RequestFile = "RequestFile" + DateTime.Now.Ticks + "." + contractor.RequestFile.FileName.Split('.')[1].ToString();
                    if (contractor.OldRegistration != null)
                        OldRegistration = "OldRegistration" + DateTime.Now.Ticks + "." + contractor.OldRegistration.FileName.Split('.')[1].ToString();
                    if (contractor.CharacterCertificate != null)
                        CharacterCertificate = "CharacterCertificate" + DateTime.Now.Ticks + "." + contractor.CharacterCertificate.FileName.Split('.')[1].ToString();
                    if (contractor.HasiyatCertificate != null)
                        HasiyatCertificate = "HasiyatCertificate" + DateTime.Now.Ticks + "." + contractor.HasiyatCertificate.FileName.Split('.')[1].ToString();
                    if (contractor.WorkCertificate != null)
                        WorkCertificate = "WorkCertificate" + DateTime.Now.Ticks + "." + contractor.WorkCertificate.FileName.Split('.')[1].ToString();
                    if (contractor.StampCertificate != null)
                        StampCertificate = "StampCertificate" + DateTime.Now.Ticks + "." + contractor.StampCertificate.FileName.Split('.')[1].ToString();
                    if (contractor.DemandDraft != null)
                        DemandDraft = "DemandDraft" + DateTime.Now.Ticks + "." + contractor.DemandDraft.FileName.Split('.')[1].ToString();
                    if (contractor.GSTR1 != null)
                        GSTR1 = "GSTR1" + DateTime.Now.Ticks + "." + contractor.GSTR1.FileName.Split('.')[1].ToString();

                    if (contractor.GSTR2 != null)
                        GSTR2 = "GSTR2" + DateTime.Now.Ticks + "." + contractor.GSTR2.FileName.Split('.')[1].ToString();
                    ...
                    Result = dAL.QueryWithExecuteAsync("InsertContractorRenewal", param);
                    if (Convert.ToInt32(Result.Statuskey) > 0)
                    {
                        string folderPath = Path.Combine(env.WebRootPath, "Upload/ContractorRenewal/" + contractor.Mobile);
                        ...
                        if (contractor.RequestFile != null)
                        {
                            string filepath = Path.Combine(folderPath, RequestFile);
                            using (var stream = new FileStream(filepath, FileMode.Create))
                            {
                                contractor.RequestFile.CopyTo(stream);
                            }
                        }
                        if (contractor.OldRegistration != null)
                        {
                            string filepath = Path.Combine(folderPath, OldRegistration);
                            using (var stream = new FileStream(filepath, FileMode.Create))
                            {
                                contractor.OldRegistration.CopyTo(stream);
                            }
                        }
                        if (contractor.CharacterCertificate != null)
                        {
                            string filepath = Path.Combine(folderPath, CharacterCertificate);
                            using (var stream = new FileStream(filepath, FileMode.Create))
                            {
                                contractor.CharacterCertificate.CopyTo(stream);
                            }
                        }
                        if (contractor.HasiyatCertificate != null)
                        {
                        ...
                        if (contractor.WorkCertificate != null)
                        {
                            string filepath = Path.Combine(folderPath, WorkCertificate);
                            using (var stream = new FileStream(filepath, FileMode.Create))
                            {
                                contractor.WorkCertificate.CopyTo(stream);
                            }
                        }
                        if (contractor.StampCertificate != null)
                        {
                            string filepath = Path.Combine(folderPath, StampCertificate);
                            using (var stream = new FileStream(filepath, FileMode.Create))
                            {
                                contractor.StampCertificate.CopyTo(stream);
                            }
                        }
                        if (contractor.DemandDraft != null)
                        {
                            string filepath = Path.Combine(folderPath, DemandDraft);
                            using (var stream = new FileStream(filepath, FileMode.Create))
                            {
                                contractor.DemandDraft.CopyTo(stream);
                            }
                        }
                        if (contractor.GSTR1 != null)
                        {
                            string filepath = Path.Combine(folderPath, GSTR1);
                            using (var stream = new FileStream(filepath, FileMode.Create))
                            {
                                contractor.GSTR1.CopyTo(stream);
                            }
                        }
                        if (contractor.GSTR2 != null)
                        {
                            string filepath = Path.Combine(folderPath, GSTR2);
                            using (var stream = new FileStream(filepath, FileMode.Create))
                            {
                                contractor.GSTR2.CopyTo(stream);
                            }
                        }
        ...
        [HttpGet]
        public async Task<JsonResult> BindMasterCategory()
        {
            ...
            try
            {
                ...
                result.Data = await dAL.QueryAsync("GetMasterCategory", null);
                if (result.Data != null)
                {
        ...
        [HttpGet]
        public async Task<JsonResult> BindMasterSubCategory(string CategoryId)
        {
            ResponseData result = new ResponseData();
            try
            {
                ...
                AppCommonMethod objapp = new AppCommonMethod();
                result.Data = await dAL.QueryAsync("GetMasterSubCategory", param);
                if (result.Data != null)
                {
                    result.ResultStatus = true;
                }
        ...
        public IActionResult RenewalSuccess()
        {
            return View();
        }
        ...
        public IActionResult ContractorRenewalTermsandConditions()
        {
            return View();
        }
        ...
        [HttpGet]
        public async Task<JsonResult> CheckContractorMobileNew(string Category, string Mobile, string SubCategory)
        {
            var res = (dynamic)null;
            try
            {
...
,
        ...
        /////////////////////////////////Bind Photo Gallery//////////////////////////
        public async Task<JsonResult> BindGallery(string Category)
        {
            var Result = (dynamic)null;
            try
            {
                //var param = new  { Category =Category };
                Result = await dAL.QueryAsync("GetPhotoGalleryHome", null);
            }
            catch (Exception ex)
            {
                await acm.InsertException(ex.Message, this.ControllerContext.RouteData.Values["controller"].ToString(), this.ControllerContext.RouteData.Values["action"].ToString(), "", "");
        ...
        public async Task<JsonResult> BindCategory()
        {
            var Result = (dynamic)null;
            try
            {
                Result = await dAL.QueryAsync("getCategoryForProgressPhotos", null);
            }
            catch (Exception ex)
            {
                await acm.InsertException(ex.Message, this.ControllerContext.RouteData.Values["controller"].ToString(), this.ControllerContext.RouteData.Values["action"].ToString(), "", "");
        ...
        [HttpGet]
        public async Task<JsonResult> GetLatestTechnicalSanction()
        {
            var Result = (dynamic)null;
            try
            {
                var param = new { Id = 0 };
                Result = await dAL.QueryAsync("GetTechnicalSanctionDetails", param);
            }
            catch (Exception ex)
            {
                await acm.InsertException(ex.Message, this.ControllerContext.RouteData.Values["controller"].ToString(), this.ControllerContext.RouteData.Values["action"].ToString(), "", "");
        ...
        public async Task<JsonResult> GetLastUpdatedRecord(string ActionName)
        {
            ...
            try
            {
                ...
                result = await dAL.SelectProcedureExecute<LastUpdated>("GetUpdatedRecord", param);
