...
//     //  jQuery(".morenav_sec").css("font-size", fontSize + "%");
// }
var $affectedElements = $("p, a, h3, ul li span, ul li i, h1"); // Can be extended, ex. $("div, p, span.someClass")
...
jQuery(document).ready(function() {
    ...
    if (getCookie('contrast') == "1") {
        //var site_temp_uri = document.getElementById("site_url_js").value;
        jQuery('head').append('<link rel="stylesheet" type="text/css" media="screen" href="theme_font_changer/change.css">');
    }
